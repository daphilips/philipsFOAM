...
#include "functionOmegaFvPatchScalarField.H"
...
functionOmegaFvPatchScalarField::functionOmegaFvPatchScalarField
(
    const fvPatch& p,
...
functionOmegaFvPatchScalarField::functionOmegaFvPatchScalarField
(
    const functionOmegaFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    y_(dict.lookup("y"))
{
    if (mag(y_) < SMALL)
    {
        FatalErrorIn("functionOmegaFvPatchScalarField(dict)")
...
functionOmegaFvPatchScalarField::functionOmegaFvPatchScalarField
(
    const functionOmegaFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void functionOmegaFvPatchScalarField::updateCoeffs()
{
...
// Write
void functionOmegaFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, functionOmegaFvPatchScalarField);
